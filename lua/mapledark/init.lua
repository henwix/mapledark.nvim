...
function M.setup(opts)
	...
	hl("Cursor", { fg = c.bg_dark, bg = c.fg })
	hl("lCursor", { fg = c.bg_dark, bg = c.fg })
	hl("CursorLine", { bg = c.bg_sel })
	hl("CursorColumn", { bg = c.bg_sel })
	hl("ColorColumn", { bg = c.bg_dark })

	hl("LineNr", { fg = c.linenr, bg = c.bg_dark, italic = true })
	hl("CursorLineNr", { fg = c.fg_dark, bg = c.bg_dark, bold = true, italic = true })
	hl("SignColumn", { bg = c.bg_dark })
	hl("FoldColumn", { fg = c.fg_dark, bg = c.bg_dark })
	...
	hl("IncSearch", { fg = c.bg_dark, bg = c.orange, bold = true })
	hl("CurSearch", { fg = c.bg_dark, bg = c.orange_br, bold = true })
	hl("Substitute", { fg = c.bg_dark, bg = c.red, bold = true })
	...
	hl("PmenuSel", { fg = c.bg_dark, bg = c.blue, bold = true })
	...
	hl("TabLineSel", { fg = c.green, bg = c.bg_dark, bold = true })
	...
	hl("DiagnosticSignError", { fg = c.red, bg = c.bg_dark })
	hl("DiagnosticSignWarn", { fg = c.orange, bg = c.bg_dark })
	hl("DiagnosticSignInfo", { fg = c.blue, bg = c.bg_dark })
	hl("DiagnosticSignHint", { fg = c.cyan, bg = c.bg_dark })
	hl("DiagnosticSignOk", { fg = c.green, bg = c.bg_dark })
	...
	-- LSP Semantic tokens
	hl("LspInlayHint", { fg = c.fg_dark, bg = c.bg_dark, italic = true })
	...
	hl("GitSignsChange", { fg = c.orange, bg = c.bg_dark })
